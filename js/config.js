...
classes:[
  ...
  {name:"Guerrier",hd:"d10",hdVal:10,saves:["FOR","CON"],armor:"Toutes, boucliers",weapons:"Simples, de guerre",weaponTypes:["simple","guerre"],armorTypes:["légère","intermédiaire","lourde","bouclier"],mcArmorTypes:["légère","intermédiaire","bouclier"],skills:["Acrobaties","Athlétisme","Dressage","Histoire","Intuition","Intimidation","Perception","Survie"],skillCount:2,spellcaster:false,spellWeight:0,mcProf:"Armure légère, intermédiaire, boucliers, armes courantes et de guerre",primaryStats:["FOR","CON"],startSpells:0,
   ...
   equipment:[
     [{name:"Cotte de mailles",qty:1,desc:"CA 16"},{name:"Épée longue",qty:1,desc:"1d8 tranchant"},{name:"Bouclier",qty:1,desc:"+2 CA"},{name:"Hachette",qty:2,desc:"1d6 tranchant"},{name:"Pack du donjon",qty:1,desc:"Pied de biche, torches"}],
     [{name:"Armure de cuir",qty:1,desc:"CA 11+DEX"},{name:"Arc long",qty:1,desc:"1d8 perforant, distance"},{name:"Flèche",qty:20,desc:"Munitions"},{name:"Épée à deux mains",qty:1,desc:"2d6 tranchant, lourde"},{name:"Pack du donjon",qty:1,desc:"Pied de biche, torches"}]]},
  {name:"Moine",hd:"d8",hdVal:8,saves:["FOR","DEX"],armor:"Aucune",weapons:"Simples, épées courtes",weaponTypes:["simple","épée courte"],armorTypes:[],skills:["Acrobaties","Athlétisme","Histoire","Intuition","Religion","Discrétion"],skillCount:2,spellcaster:false,spellWeight:0,mcProf:"Armes courantes, épée courte",primaryStats:["DEX","SAG"],startSpells:0,
   ...
   equipment:[[{name:"Épée courte",qty:1,desc:"1d6 perforant, finesse"},{name:"Fléchette",qty:10,desc:"1d4 perforant"},{name:"Pack du donjon",qty:1,desc:"Pied de biche, torches"}]]},
  {name:"Paladin",hd:"d10",hdVal:10,saves:["SAG","CHA"],armor:"Toutes, boucliers",weapons:"Simples, de guerre",weaponTypes:["simple","guerre"],armorTypes:["légère","intermédiaire","lourde","bouclier"],mcArmorTypes:["légère","intermédiaire","bouclier"],skills:["Athlétisme","Intuition","Intimidation","Médecine","Persuasion","Religion"],skillCount:2,spellcaster:true,spellWeight:0.5,mcProf:"Armure légère, intermédiaire, boucliers, armes courantes et de guerre",primaryStats:["FOR","CHA"],startSpells:0,
   ...
   equipment:[[{name:"Épée longue",qty:1,desc:"1d8 tranchant"},{name:"Cotte de mailles",qty:1,desc:"CA 16"},{name:"Bouclier",qty:1,desc:"+2 CA"},{name:"Javeline",qty:5,desc:"1d6 perforant"},{name:"Sac d'ecclésiastique",qty:1,desc:"Bougies, rations, encens"},{name:"Symbole sacré",qty:1,desc:"Focaliseur divin"}]]},
  {name:"Rôdeur",hd:"d10",hdVal:10,saves:["FOR","DEX"],armor:"Légères, intermédiaires, boucliers",weapons:"Simples, de guerre",weaponTypes:["simple","guerre"],armorTypes:["légère","intermédiaire","bouclier"],skills:["Athlétisme","Dressage","Intuition","Investigation","Nature","Perception","Discrétion","Survie"],skillCount:3,mcSkillCount:1,spellcaster:true,spellWeight:0.5,mcProf:"Armure légère, intermédiaire, boucliers, armes courantes et de guerre, une compétence",primaryStats:["DEX","SAG"],startSpells:0,
   ...
   equipment:[
     [{name:"Armure d'écailles",qty:1,desc:"CA 14+DEX(max2)"},{name:"Épée courte",qty:2,desc:"1d6 perforant, finesse"},{name:"Arc long",qty:1,desc:"1d8 perforant, distance"},{name:"Flèche",qty:20,desc:"Munitions"},{name:"Pack du donjon",qty:1,desc:"Pied de biche, torches"}],
     [{name:"Armure de cuir",qty:1,desc:"CA 11+DEX"},{name:"Épée courte",qty:2,desc:"1d6 perforant, finesse"},{name:"Arc long",qty:1,desc:"1d8 perforant, distance"},{name:"Flèche",qty:20,desc:"Munitions"},{name:"Pack du donjon",qty:1,desc:"Pied de biche, torches"}]]},
  ...
  {name:"Ensorceleur",hd:"d6",hdVal:6,saves:["CON","CHA"],armor:"Aucune",weapons:"Dagues, fléchettes, frondes, bâtons, arbalètes légères",weaponTypes:["dague","fléchette","fronde","bâton","arbalète légère"],armorTypes:[],skills:["Arcanes","Tromperie","Intuition","Intimidation","Persuasion","Religion"],skillCount:2,spellcaster:true,spellWeight:1,mcProf:"—",primaryStats:["CHA","CON"],startSpells:6,
   ...
   equipment:[[{name:"Arbalète légère",qty:1,desc:"1d8 perforant"},{name:"Carreau",qty:20,desc:"Munitions"},{name:"Focaliseur arcanique",qty:1,desc:"Cristal ou baguette"},{name:"Pack du donjon",qty:1,desc:"Pied de biche, torches"},{name:"Dague",qty:2,desc:"1d4 perforant, finesse"}]]},
  {name:"Occultiste",hd:"d8",hdVal:8,saves:["SAG","CHA"],armor:"Légères",weapons:"Simples",weaponTypes:["simple"],armorTypes:["légère"],skills:["Arcanes","Tromperie","Histoire","Intimidation","Investigation","Nature","Religion"],skillCount:2,spellcaster:true,spellWeight:1,mcProf:"Armure légère, armes courantes",primaryStats:["CHA","CON"],startSpells:2,
   ...
   equipment:[[{name:"Arbalète légère",qty:1,desc:"1d8 perforant"},{name:"Carreau",qty:20,desc:"Munitions"},{name:"Armure de cuir",qty:1,desc:"CA 11+DEX"},{name:"Focaliseur arcanique",qty:1,desc:"Cristal"},{name:"Sac d'érudit",qty:1,desc:"Livre, plume, encre, parchemins"},{name:"Dague",qty:2,desc:"1d4 perforant, finesse"}]]},
  ...
  {name:"Artificier",hd:"d8",hdVal:8,saves:["CON","INT"],armor:"Légères, intermédiaires, boucliers",weapons:"Simples, arbalètes",weaponTypes:["simple","arbalète légère","arbalète lourde"],armorTypes:["légère","intermédiaire","bouclier"],skills:["Arcanes","Histoire","Investigation","Médecine","Nature","Perception","Escamotage"],skillCount:2,spellcaster:true,spellWeight:0.5,mcProf:"Armure légère, intermédiaire, boucliers",primaryStats:["INT","CON"],startSpells:2,
   ...
   equipment:[[{name:"Arbalète légère",qty:1,desc:"1d8 perforant"},{name:"Carreau",qty:20,desc:"Munitions"},{name:"Armure d'écailles",qty:1,desc:"CA 14+DEX(max2)"},{name:"Outils de voleur",qty:1,desc:"Maîtrise requise"},{name:"Pack du donjon",qty:1,desc:"Pied de biche, torches"}]]},
],
draconicAncestries:[
...
races:[
  ...
  {name:"Demi-Elfe",speed:9,bonuses:[0,0,0,0,0,2],flexOptions:[[1,1]],traits:"+2 CHA, +1 à deux autres au choix. Vision nuit 18m, résistance enchantement, 2 compétences.",languages:"Commun, Elfique + 1 au choix"},
  ...
  {name:"Dragonide métallique",speed:9,bonuses:[0,0,0,0,0,0],flexOptions:[[2,1],[1,1,1]],traits:"Bonus flexible : +2 à une carac. au choix et +1 à une autre, OU +1 à trois carac. au choix. Ascendance métallique au choix (airain/argent/bronze/cuivre/or → feu/froid/foudre/acide/feu). Souffle : remplace une attaque, cône 4,5m, JS DEX, 1d10→4d10, récup. bonus maîtrise fois/repos long. Résistance au type correspondant. Niv.5 : Souffle métallique (1/repos long : effet débilitant ou repoussé 6m).",languages:"Commun + 1 au choix"},
...
const RARITY_INFO={Commun:{color:'#9e9e9e',level:'Niv. 1+',price:'50–100 po'},'Peu commun':{color:'var(--good)',level:'Niv. 1+',price:'101–500 po'},Rare:{color:'var(--info)',level:'Niv. 5+',price:'501–5 000 po'},'Très rare':{color:'var(--arcane)',level:'Niv. 11+',price:'5 001–50 000 po'},Légendaire:{color:'var(--cp)',level:'Niv. 17+',price:'50 001+ po'},Artefact:{color:'var(--danger)',level:'Unique',price:'Inestimable'}};
const BEAST_FORMS=[
