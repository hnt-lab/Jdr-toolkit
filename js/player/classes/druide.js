...
function openElementalModal() {
  ...
  openWideModal(`<div class="pt">🌊 Entrer en Forme élémentaire</div>
    <div style="font-size:17px;color:var(--text3);margin-bottom:10px">CR 5 — Charges : <strong style="color:var(--cp)">${feUsed}/${feMax}</strong> • Repos long</div>
