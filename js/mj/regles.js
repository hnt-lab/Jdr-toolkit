function mjTabRegles(){
  ...
  function dh(id,title){const col=_rulesCollapsed[id];return`<div class="pt" style="display:flex;align-items:center;gap:6px;cursor:pointer;user-select:none" onclick="toggleRuleSection('${id}')"><span class="mj-drag-handle" title="Glisser pour réorganiser" onclick="event.stopPropagation()">⠿</span>${title}<span id="rschev_${id}" style="margin-left:auto;font-size:12px;color:var(--text3);transition:transform .2s${col?';transform:rotate(-90deg)':''}">▼</span></div>`;}
  function gh(id,label){const col=_rulesCollapsed[id];return`<div style="display:flex;align-items:center;gap:6px;padding:4px 0 8px;color:var(--text3);font-size:13px;cursor:pointer;user-select:none" onclick="toggleRuleSection('${id}')"><span class="mj-drag-handle" title="Glisser pour réorganiser" onclick="event.stopPropagation()">⠿</span>${label}<span id="rschev_${id}" style="margin-left:auto;font-size:12px;transition:transform .2s${col?';transform:rotate(-90deg)':''}">▼</span></div>`;}
  ...
  return`<div id="mjRulesContainer">
    ...
    ${rb('s-actions',`<div class="g2" style="gap:10px">
      <div class="regles-section">
        ...
        <div style="font-size:13px;color:var(--text3);margin-top:8px;line-height:1.8">
    ...
    ${rb('s-couverture',`<div class="g2" style="gap:10px">
      <div class="regles-section">
        ...
        <div style="font-size:13px;color:var(--text3);margin-top:4px">Si plusieurs sources : seul le type le plus élevé s'applique (pas de cumul).</div>
      </div>
      <div class="regles-section">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:13px;color:var(--text3);margin-top:4px">Se faufiler dans un espace d'1 taille en dessous : coût ×2, désavantage attaques et JS DEX, attaques contre lui en avantage.</div>
      </div>
      <div class="regles-section">
        <div class="pt">💥 Types de dégâts</div>
        <table class="regles-table" style="font-size:13px">
    ...
    ${ds('s-armes-c',`<div class="regles-section">
      ...
      ${rb('s-armes-c',`<table class="regles-table">
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:13px;font-weight:600">Corps à corps</td></tr>
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:13px;font-weight:600">À distance</td></tr>
    ...
    ${ds('s-armures',`<div class="regles-section">
      ...
      ${rb('s-armures',`<table class="regles-table">
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:13px;font-weight:600">Légères</td></tr>
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:13px;font-weight:600">Intermédiaires</td></tr>
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:13px;font-weight:600">Lourdes</td></tr>
      ...
      <div style="font-size:12px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin:10px 0 4px">Mettre / Ôter une armure</div>
      <table class="regles-table">
    ...
    ${ds('s-modifs',`<div class="regles-section">
      ...
      ${rb('s-modifs',`<table class="regles-table">
        ...
        <tr><td>1</td><td style="color:var(--danger)">−5</td></tr>
        <tr><td>2–3</td><td style="color:var(--danger)">−4</td></tr>
        <tr><td>4–5</td><td style="color:var(--danger)">−3</td></tr>
        <tr><td>6–7</td><td style="color:var(--danger)">−2</td></tr>
        <tr><td>8–9</td><td style="color:var(--danger)">−1</td></tr>
    ...
    ${ds('s-multiclasse',`<div class="regles-section">
      ...
      ${rb('s-multiclasse',`<div style="font-size:13px;color:var(--text3);margin-bottom:8px">Option : ajouter un niveau dans une autre classe plutôt que dans sa classe actuelle. Nécessite les valeurs minimum dans les deux classes.</div>
      <div class="g2" style="gap:10px">
        <div>
          <div style="font-size:12px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Prérequis</div>
          <table class="regles-table">
        ...
        <div>
          <div style="font-size:12px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Maîtrises gagnées (nouveau niveau)</div>
          <table class="regles-table">
      ...
      <div style="font-size:12px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin:10px 0 4px">Emplacements de sorts multiclasse (niveau total de lanceur)</div>
    ...
    ${ds('s-epuisement',`<div class="regles-section">
      ...
      ${rb('s-epuisement',`<div style="font-size:12px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Niveaux d'épuisement</div>
        <table class="regles-table">
          ...
          <tr><td style="color:var(--danger);font-weight:600">6</td><td style="color:var(--danger)">Mort</td></tr>
        </table>
        <div style="font-size:13px;color:var(--text3);margin-top:5px;margin-bottom:10px">Repos long : −1 niveau d'épuisement.</div>
        <div style="font-size:12px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Faim</div>
        ...
        <div style="font-size:12px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Soif</div>
    ...
    ${rb('s-voyage',`<div class="g2" style="gap:10px">
      <div class="regles-section">
        ...
        <table class="regles-table">
          ...
          <tr><td>Rapide</td><td>120 m</td><td>6 km</td><td>45 km</td><td style="color:var(--danger)">−5 Percep.</td></tr>
        ...
        <div style="font-size:13px;color:var(--text3);margin-top:6px;line-height:1.7">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:13px;color:var(--text3);margin-top:6px">Atterrissage en terrain difficile → DEX (Acrobaties) DD 10 ou chute à terre.</div>
      </div>
      <div class="regles-section">
    ...
    ${rb('s-vie',`<div class="g2" style="gap:10px">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:13px;color:var(--text3);margin-top:6px">5 ft = 1,5 m &nbsp;·&nbsp; 1 mile = 1,5 km &nbsp;·&nbsp; 1 lb = 500 g</div>
      </div>
    </div>`)}`)}
    ...
    ${rb('s-temps-mort',`
      ...
      <div class="regles-section">
        ...
        <div style="font-size:12px;color:var(--text3);margin-top:6px">Complications : 10% de chances par semaine d'activité. Absent lors d'une construction = +3 jours par jour d'absence.</div>
      </div>
    `)}`)}
    ...
    ${ds('s-services',`<div class="regles-section">
      ...
      <div style="font-size:13px;color:var(--text3);margin-top:6px;line-height:1.7"><strong>Sorts niv.1–2</strong> : 10–50 po + composantes coûteuses &nbsp;·&nbsp; Sorts niv. supérieur : temple ou université, tarif ou service rendu en échange</div>`)}
    </div>`)}
    ...
    ${ds('s-mort',`<div class="regles-section">
      ...
      ${rb('s-mort',`<div style="font-size:13px;color:var(--text2);line-height:1.8">
        ...
        • <strong style="color:var(--good)">10+</strong> → Succès (3 succès = stable, inconscient mais vivant).<br>
        • <strong style="color:var(--danger)">1-9</strong> → Échec (3 échecs = mort).<br>
        • <strong style="color:var(--cp)">1 naturel</strong> → 2 échecs d'un coup.<br>
        • <strong style="color:var(--cp)">20 naturel</strong> → Retour à 1 PV, debout.<br>
    ...
    ${rb('s-incantation',`<div class="g2" style="gap:10px">
      <div class="regles-section">
        ...
        <div style="font-size:13px;color:var(--text3);margin-top:6px">Caractéristique d'incantation : INT (Magicien), SAG (Clerc/Druide/Rôdeur), CHA (Barde/Paladin/Ensorceleur/Occultiste)</div>
      </div>
      <div class="regles-section">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:13px;color:var(--text3);margin-top:4px">Obstrué par un abri total. Ligne droite du point d'origine vers chaque case — si bloquée, case exclue de la zone.</div>
      </div>
      <div class="regles-section">
    ...
    ${ds('s-magie-sauvage',`<div class="regles-section">
      ...
      ${rb('s-magie-sauvage',`<div style="font-size:13px;color:var(--text3);margin-bottom:8px">Déclenché par <strong>Marée du chaos</strong> ou à la discrétion du MJ après qu'un ensorceleur lance un sort. Lancez 1d100.</div>
      ...
      <table class="regles-table" style="font-size:13px">
        ...
        <tr><td style="color:var(--danger);font-weight:600">07–08</td><td><strong>Boule de feu</strong> niv. 3 centrée sur vous-même.</td></tr>
        ...
        <tr><td style="color:var(--danger);font-weight:600">13–14</td><td><strong>Confusion</strong> centrée sur vous-même.</td></tr>
        ...
        <tr><td style="color:var(--danger);font-weight:600">19–20</td><td><strong>Graisse</strong> centrée sur vous-même.</td></tr>
        <tr><td style="color:var(--danger);font-weight:600">21–22</td><td>Les créatures ont le désavantage aux JS contre votre prochain sort lancé dans la prochaine minute.</td></tr>
        ...
        <tr><td style="color:var(--danger);font-weight:600">41–42</td><td>Vous devenez une plante en pot jusqu'à votre prochain tour : neutralisé, vulnérabilité à tous les dégâts.</td></tr>
        ...
        <tr><td style="color:var(--danger);font-weight:600">59–60</td><td>Téléportation jusqu'à 18 m ; toutes les créatures dans l'espace d'arrivée subissent 1d10 dégâts de force.</td></tr>
        <tr><td style="color:var(--danger);font-weight:600">61–62</td><td>Vous êtes effrayé par la créature la plus proche jusqu'à la fin de votre prochain tour.</td></tr>
        ...
        <tr><td style="color:var(--danger);font-weight:600">67–68</td><td>Une créature aléatoire dans un rayon de 18 m est empoisonnée pendant 1d4 heures.</td></tr>
        ...
        <tr><td style="color:var(--danger);font-weight:600">71–72</td><td><strong>Métamorphose</strong> sur vous-même. En cas d'échec au JS, vous devenez un mouton pour la durée du sort.</td></tr>
        ...
        <tr><td style="color:var(--danger);font-weight:600">89–90</td><td>Vous et toutes les créatures dans un rayon de 9 m gagnez la vulnérabilité aux dégâts perforants pendant 1 minute.</td></tr>
        ...
        <tr><td style="color:var(--danger);font-weight:600">95–96</td><td>Pendant 1 minute, vous devez crier quand vous parlez.</td></tr>
    ...
    ${ds('s-rencontres',`<div class="regles-section">
      ...
      ${rb('s-rencontres',`
        <div style="font-size:13px;color:var(--text3);margin-bottom:8px"><strong>Étapes :</strong> 1) Seuils XP du groupe par difficulté · 2) Additionner XP des monstres · 3) Appliquer le multiplicateur · 4) Comparer aux seuils.</div>
        <div style="display:flex;gap:10px;flex-wrap:wrap">
          <div style="flex:1;min-width:200px">
            <div style="font-size:13px;font-weight:600;color:var(--text2);margin-bottom:4px">Seuils XP par PJ et par niveau</div>
            <div style="max-height:210px;overflow-y:auto">
            <table class="regles-table" style="font-size:12px">
              <tr><th>Niv.</th><th style="color:var(--good)">Facile</th><th style="color:var(--warn)">Moy.</th><th style="color:#f44336">Diff.</th><th style="color:var(--danger)">Mort.</th></tr>
          ...
          <div style="flex:0 0 auto">
            <div style="font-size:13px;font-weight:600;color:var(--text2);margin-bottom:4px">Multiplicateur</div>
            <table class="regles-table" style="font-size:13px">
            ...
            <div style="font-size:12px;color:var(--text3);margin-top:6px;line-height:1.5"><strong>Budget journalier</strong> :<br>6–8 rencontres Moyennes<br>avant épuisement.</div>
          </div>
        </div>
      `)}
    </div>`)}
      ...
      <div class="g2" style="gap:10px">
        ...
        <div>
          ...
          <div class="regles-section">
            ...
            <div style="font-size:13px;color:var(--text2);line-height:1.5;margin-bottom:6px">JS SAG ou CHA pour résister. Guérison : <em>apaisement des émotions</em> (supprime), <em>restauration partielle</em> (courte/longue), <em>restauration supérieure</em> (illimitée).</div>
            <table class="regles-table" style="font-size:12px">
    ...
    ${rb('s-objets-mag',`
      <div class="g2" style="gap:10px">
        <div class="regles-section">
          ...
          <div style="font-size:12px;color:var(--text3);margin-top:6px;line-height:1.5">Prix de revente = ½ du prix de liste. Objets consommables (potions, parchemins) = ½ prix.</div>
        </div>
        <div class="regles-section">
      ...
      ${rb('s-pieges',`
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap">
          <div style="flex:1;min-width:180px">
            <div style="font-size:13px;font-weight:600;color:var(--text2);margin-bottom:4px">DD et bonus d'attaque</div>
            <table class="regles-table" style="font-size:13px">
          ...
          <div style="flex:1;min-width:200px">
            <div style="font-size:13px;font-weight:600;color:var(--text2);margin-bottom:4px">Dégâts par niveau</div>
            <table class="regles-table" style="font-size:13px">
    ...
    ${rb('s-comparses',`
      <div style="font-size:13px;color:var(--text3);margin-bottom:8px">PNJ spéciaux qui rejoignent le groupe. Le MJ choisit le type ou laisse les joueurs décider. 3 types disponibles :</div>
      <div class="g2" style="gap:10px">
        <div class="regles-section">
          <div class="pt">⚔ Compagnon d'armes</div>
          <div style="font-size:12px;color:var(--text3);margin-bottom:4px">Maîtrise : toutes armures, armes courantes &amp; de guerre, boucliers</div>
          <table class="regles-table" style="font-size:12px">
        ...
        <div class="regles-section">
          ...
          <div style="font-size:12px;color:var(--text3);margin-bottom:4px">Maîtrise : armes courantes, rapières, épées courtes, armures légères</div>
          <table class="regles-table" style="font-size:12px">
            <tr><th>Niv.</th><th>PV max</th><th>Capacité</th></tr>
        ...
        <div class="regles-section">
          ...
          <div style="font-size:12px;color:var(--text3);margin-bottom:4px">Maîtrise : armes courantes, armures légères. 2 rôles : Guérisseur ou Mage</div>
          <table class="regles-table" style="font-size:12px">
    ...
    ${ds('s-compendium',`<div class="regles-section">
      ...
      ${rb('s-compendium',`<div style="font-size:13px;color:var(--text3);margin-bottom:10px">Référence rapide — descriptions en français</div>
      <div style="display:flex;gap:6px;margin-bottom:10px;flex-wrap:wrap">
        ...
        ${_mjReglesComp?'<button class="btn bsm" style="color:var(--danger);border-color:var(--danger)" onclick="mjSetReglesComp(\'\')">✕ Fermer</button>':''}
      </div>
...
function mjFilterComp(q){
  ...
  el.innerHTML=res.map(e=>{
    ...
    return`<div style="border:1px solid var(--border);border-radius:2px;padding:10px;margin-bottom:6px;background:var(--surface2)">
      <div style="font-size:13px;font-weight:600;color:var(--text);margin-bottom:4px">${esc(e.n)}</div>
      ${meta?`<div style="font-size:13px;color:var(--text3);margin-bottom:4px">${meta}</div>`:''}
      <div style="font-size:13px;color:var(--text2);line-height:1.5">${esc(e.tx||'')}</div>
    </div>`;
  }).join('');
}
