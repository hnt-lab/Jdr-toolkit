function mjTabRegles(){
  ...
  function dh(id,title){const col=_rulesCollapsed[id];return`<div class="pt" style="display:flex;align-items:center;gap:6px;cursor:pointer;user-select:none" onclick="toggleRuleSection('${id}')"><span class="mj-drag-handle" title="Glisser pour réorganiser" onclick="event.stopPropagation()">⠿</span>${title}<span id="rschev_${id}" style="margin-left:auto;font-size:15px;color:var(--text3);transition:transform .2s${col?';transform:rotate(-90deg)':''}">▼</span></div>`;}
  function gh(id,label){const col=_rulesCollapsed[id];return`<div style="display:flex;align-items:center;gap:6px;padding:4px 0 8px;color:var(--text3);font-size:17px;cursor:pointer;user-select:none" onclick="toggleRuleSection('${id}')"><span class="mj-drag-handle" title="Glisser pour réorganiser" onclick="event.stopPropagation()">⠿</span>${label}<span id="rschev_${id}" style="margin-left:auto;font-size:15px;transition:transform .2s${col?';transform:rotate(-90deg)':''}">▼</span></div>`;}
  ...
  return`<div id="mjRulesContainer">
    ...
    ${rb('s-actions',`<div class="g2" style="gap:10px">
      <div class="regles-section">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:8px;line-height:1.8">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:18px;color:var(--text2);line-height:1.8">
    ...
    ${rb('s-couverture',`<div class="g2" style="gap:10px">
      <div class="regles-section">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:4px">Si plusieurs sources : seul le type le plus élevé s'applique (pas de cumul).</div>
      </div>
      <div class="regles-section">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:4px">Se faufiler dans un espace d'1 taille en dessous : coût ×2, désavantage attaques et JS DEX, attaques contre lui en avantage.</div>
      </div>
      <div class="regles-section">
        <div class="pt">💥 Types de dégâts</div>
        <table class="regles-table" style="font-size:17px">
    ...
    ${ds('s-armes-c',`<div class="regles-section">
      ...
      ${rb('s-armes-c',`<table class="regles-table">
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:17px;font-weight:600">Corps à corps</td></tr>
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:17px;font-weight:600">À distance</td></tr>
    ...
    ${ds('s-armures',`<div class="regles-section">
      ...
      ${rb('s-armures',`<table class="regles-table">
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:17px;font-weight:600">Légères</td></tr>
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:17px;font-weight:600">Intermédiaires</td></tr>
        ...
        <tr><td colspan="3" style="color:var(--cp);font-size:17px;font-weight:600">Lourdes</td></tr>
      ...
      <div style="font-size:15px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin:10px 0 4px">Mettre / Ôter une armure</div>
      <table class="regles-table">
    ...
    ${ds('s-multiclasse',`<div class="regles-section">
      ...
      ${rb('s-multiclasse',`<div style="font-size:17px;color:var(--text3);margin-bottom:8px">Option : ajouter un niveau dans une autre classe plutôt que dans sa classe actuelle. Nécessite les valeurs minimum dans les deux classes.</div>
      <div class="g2" style="gap:10px">
        <div>
          <div style="font-size:15px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Prérequis</div>
          <table class="regles-table">
        ...
        <div>
          <div style="font-size:15px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Maîtrises gagnées (nouveau niveau)</div>
          <table class="regles-table">
      ...
      <div style="font-size:15px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin:10px 0 4px">Emplacements de sorts multiclasse (niveau total de lanceur)</div>
    ...
    ${ds('s-epuisement',`<div class="regles-section">
      ...
      ${rb('s-epuisement',`<div style="font-size:15px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Niveaux d'épuisement</div>
        <table class="regles-table">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:5px;margin-bottom:10px">Repos long : −1 niveau d'épuisement.</div>
        <div style="font-size:15px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Faim</div>
        <div style="font-size:18px;color:var(--text2);line-height:1.7;margin-bottom:8px">
        ...
        <div style="font-size:15px;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px">Soif</div>
        <div style="font-size:18px;color:var(--text2);line-height:1.7">
    ...
    ${rb('s-voyage',`<div class="g2" style="gap:10px">
      <div class="regles-section">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:6px;line-height:1.7">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:6px">Atterrissage en terrain difficile → DEX (Acrobaties) DD 10 ou chute à terre.</div>
      </div>
      <div class="regles-section">
    ...
    ${rb('s-vie',`<div class="g2" style="gap:10px">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:6px">5 ft = 1,5 m &nbsp;·&nbsp; 1 mile = 1,5 km &nbsp;·&nbsp; 1 lb = 500 g</div>
      </div>
    </div>`)}`)}
    ...
    ${rb('s-temps-mort',`
      <div class="regles-section" style="margin-bottom:10px">
        ...
        <div style="font-size:18px;color:var(--text2);line-height:1.6">
      ...
      <div class="regles-section">
        ...
        <table class="regles-table" style="font-size:15px">
        ...
        <div style="font-size:15px;color:var(--text3);margin-top:6px">Complications : 10% de chances par semaine d'activité. Absent lors d'une construction = +3 jours par jour d'absence.</div>
      </div>
    `)}`)}
    ...
    ${ds('s-services',`<div class="regles-section">
      ...
      <div style="font-size:17px;color:var(--text3);margin-top:6px;line-height:1.7"><strong>Sorts niv.1–2</strong> : 10–50 po + composantes coûteuses &nbsp;·&nbsp; Sorts niv. supérieur : temple ou université, tarif ou service rendu en échange</div>`)}
    </div>`)}
    ...
    ${ds('s-mort',`<div class="regles-section">
      ...
      ${rb('s-mort',`<div style="font-size:18px;color:var(--text2);line-height:1.8">
    ...
    ${rb('s-incantation',`<div class="g2" style="gap:10px">
      <div class="regles-section">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:6px">Caractéristique d'incantation : INT (Magicien), SAG (Clerc/Druide/Rôdeur), CHA (Barde/Paladin/Ensorceleur/Occultiste)</div>
      </div>
      <div class="regles-section">
      ...
      <div class="regles-section">
        ...
        <div style="font-size:17px;color:var(--text3);margin-top:4px">Obstrué par un abri total. Ligne droite du point d'origine vers chaque case — si bloquée, case exclue de la zone.</div>
      </div>
      <div class="regles-section">
    ...
    ${ds('s-magie-sauvage',`<div class="regles-section">
      ...
      ${rb('s-magie-sauvage',`<div style="font-size:17px;color:var(--text3);margin-bottom:8px">Déclenché par <strong>Marée du chaos</strong> ou à la discrétion du MJ après qu'un ensorceleur lance un sort. Lancez 1d100.</div>
    ...
    ${ds('s-rencontres',`<div class="regles-section">
      ...
      ${rb('s-rencontres',`
        <div style="font-size:17px;color:var(--text3);margin-bottom:8px"><strong>Étapes :</strong> 1) Seuils XP du groupe par difficulté · 2) Additionner XP des monstres · 3) Appliquer le multiplicateur · 4) Comparer aux seuils.</div>
        <div style="display:flex;gap:10px;flex-wrap:wrap">
          <div style="flex:1;min-width:200px">
            <div style="font-size:17px;font-weight:600;color:var(--text2);margin-bottom:4px">Seuils XP par PJ et par niveau</div>
          ...
          <div style="flex:0 0 auto">
            <div style="font-size:17px;font-weight:600;color:var(--text2);margin-bottom:4px">Multiplicateur</div>
            <table class="regles-table" style="font-size:17px">
            ...
            <div style="font-size:15px;color:var(--text3);margin-top:6px;line-height:1.5"><strong>Budget journalier</strong> :<br>6–8 rencontres Moyennes<br>avant épuisement.</div>
          </div>
        </div>
      `)}
    </div>`)}
    ...
    ${rb('s-alterations',`
      <div class="g2" style="gap:10px">
        <div class="regles-section">
          ...
          <div style="font-size:17px;color:var(--text2);line-height:1.6">
        ...
        <div>
          ...
          <div class="regles-section">
            ...
            <div style="font-size:17px;color:var(--text2);line-height:1.5;margin-bottom:6px">JS SAG ou CHA pour résister. Guérison : <em>apaisement des émotions</em> (supprime), <em>restauration partielle</em> (courte/longue), <em>restauration supérieure</em> (illimitée).</div>
            <table class="regles-table" style="font-size:15px">
    ...
    ${rb('s-objets-mag',`
      <div class="g2" style="gap:10px">
        <div class="regles-section">
          ...
          <div style="font-size:15px;color:var(--text3);margin-top:6px;line-height:1.5">Prix de revente = ½ du prix de liste. Objets consommables (potions, parchemins) = ½ prix.</div>
        </div>
        <div class="regles-section">
    ...
    ${ds('s-pieges',`<div class="regles-section">
      ${dh('s-pieges','🪤 Pièges')}
      ${rb('s-pieges',`
        <div style="font-size:17px;color:var(--text2);margin-bottom:8px;line-height:1.6">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap">
          <div style="flex:1;min-width:180px">
            <div style="font-size:17px;font-weight:600;color:var(--text2);margin-bottom:4px">DD et bonus d'attaque</div>
            <table class="regles-table" style="font-size:17px">
          ...
          <div style="flex:1;min-width:200px">
            <div style="font-size:17px;font-weight:600;color:var(--text2);margin-bottom:4px">Dégâts par niveau</div>
            <table class="regles-table" style="font-size:17px">
        ...
        <div style="font-size:17px;color:var(--text2);margin-top:8px;line-height:1.6">
    ...
    ${rb('s-comparses',`
      <div style="font-size:17px;color:var(--text3);margin-bottom:8px">PNJ spéciaux qui rejoignent le groupe. Le MJ choisit le type ou laisse les joueurs décider. 3 types disponibles :</div>
      <div class="g2" style="gap:10px">
        <div class="regles-section">
          <div class="pt">⚔ Compagnon d'armes</div>
          <div style="font-size:15px;color:var(--text3);margin-bottom:4px">Maîtrise : toutes armures, armes courantes &amp; de guerre, boucliers</div>
          <table class="regles-table" style="font-size:15px">
        ...
        <div class="regles-section">
          ...
          <div style="font-size:15px;color:var(--text3);margin-bottom:4px">Maîtrise : armes courantes, rapières, épées courtes, armures légères</div>
          <table class="regles-table" style="font-size:15px">
            <tr><th>Niv.</th><th>PV max</th><th>Capacité</th></tr>
        ...
        <div class="regles-section">
          ...
          <div style="font-size:15px;color:var(--text3);margin-bottom:4px">Maîtrise : armes courantes, armures légères. 2 rôles : Guérisseur ou Mage</div>
          <table class="regles-table" style="font-size:15px">
    ...
    ${ds('s-compendium',`<div class="regles-section">
      ...
      ${rb('s-compendium',`<div style="font-size:17px;color:var(--text3);margin-bottom:10px">Référence rapide — descriptions en français</div>
      ...
      ${_mjReglesComp?'<input class="fi" id="compSearch" placeholder="Rechercher..." oninput="mjFilterComp(this.value)" style="margin-bottom:8px" autofocus><div id="compResults" style="max-height:300px;overflow-y:auto"></div>':'<div style="font-size:18px;color:var(--text3);font-style:italic">Cliquez sur une catégorie pour rechercher.</div>'}`)}
    </div>`)}
  </div>`;
}
...
function mjFilterComp(q){
  ...
  if(!db){el.innerHTML='<div style="font-size:18px;color:var(--text3);text-align:center;padding:8px">Compendium non chargé — revenez dans un instant.</div>';return;}
  if(!q.trim()){
    el.innerHTML='<div style="font-size:18px;color:var(--text3);text-align:center;padding:8px">Tapez pour rechercher parmi '+db.length+' entrées.</div>';
    return;
  }
  ...
  if(!res.length){el.innerHTML='<div style="font-size:18px;color:var(--text3);text-align:center;padding:8px">Aucun résultat.</div>';return;}
  el.innerHTML=res.map(e=>{
    ...
    return`<div style="border:1px solid var(--border);border-radius:8px;padding:10px;margin-bottom:6px;background:var(--surface2)">
      <div style="font-size:18px;font-weight:600;color:var(--text);margin-bottom:4px">${esc(e.n)}</div>
      ${meta?`<div style="font-size:17px;color:var(--text3);margin-bottom:4px">${meta}</div>`:''}
      <div style="font-size:17px;color:var(--text2);line-height:1.5">${esc(e.tx||'')}</div>
    </div>`;
  }).join('');
}
